...
namespace Lab_5.Views
{
    ...
    */
    public class FlexibleMessageBox
    {
        ...
        /// </summary>
        public static Font FONT = System.Drawing.SystemFonts.MessageBoxFont;
        ...
        class FlexibleMessageBoxForm : Form
        {
            ...
            private static void SetDialogSizes(FlexibleMessageBoxForm flexibleMessageBoxForm, string text, string caption)
            {
                ...
                flexibleMessageBoxForm.MaximumSize = new System.Drawing.Size(Convert.ToInt32(SystemInformation.WorkingArea.Width * FlexibleMessageBoxForm.GetCorrectedWorkingAreaFactor(MAX_WIDTH_FACTOR)),
                ...
                var captionWidth = TextRenderer.MeasureText(caption, System.Drawing.SystemFonts.CaptionFont).Width;
                ...
                flexibleMessageBoxForm.Size = new System.Drawing.Size(textWidth + marginWidth,
